...
@box[south-west span-30 text-center text-05 bg-gold text-white box-small-padding rounded](**SPAM**)

@box[north text-center bg-black text-white box-wide-padding waved](**BÚSCATE la vida**)

@box[south text-center text-05 bg-gold text-white box-wide-padding rounded](**SPAM**)
