...
@box[south-west span-20 text-center text-05 bg-gold text-white box-small-padding rounded](**SPAM**)

@box[north text-center bg-black text-white box-wide-padding waved](**BÚSCATE la vida**)

@box[south span-20 text-center text-05 bg-gold text-white box-small-padding rounded](**SPAM**)

@box[south-east span-20 text-center text-05 bg-gold text-white box-small-padding rounded](**SPAM**)
